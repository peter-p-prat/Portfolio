...
import { fondoColor, iconClosedColor, iconOpenedColor, menuColor1, textoFondoColor, fondoColorClaro, sombraColorHover, h1Color, h1ColorOpposite } from './ui/theme';
...
const Proyecto = ({nombre, tecnologias, enlace, repo, imagen}) => {
